...
insert into cliente (codigo, nome, telefone) values(null, 'Amanda', '(11) 94444-4321');
...
insert into cliente (codigo, nome, telefone) values(null, 'João Roberto', '(19) 87878-4446');
insert into cliente (codigo, nome, telefone) values(null, 'Daniela Cristina', '(19) 87878-4446');
...
-- foreign key = chave estrangera, ligar com a outra tabela
...
insert into veiculo values(null, 'VW', 'Gol', 12);
insert into veiculo values(null, 'Chevrolet', 'Astra', 13);
insert into veiculo values(null, 'BMW', 'X1', 14);

-- buscar todos os dados de todos os veículos
select *
from veiculo;

-- quais os nomes dos proprietários de cada veículo?
